...
class TopoTijdreis:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TopoTijdreis_{}.qm'.format(locale))
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/topo_tijdreis/icon.png'
        self.add_action(
            icon_path,
    ...
    def unload(self):
        ...
        #print "** UNLOAD TopoTijdreis"

        for action in self.actions:
            self.iface.removePluginWebMenu(
                self.tr(u'&TopoTijdreis'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                years = ['1815', '1820', '1821', '1823_1829', '1830_1849', '1850', '1857', '1858', '1861', '1862', '1865', '1866', '1868', '1870', '1871', '1872', '1880', '1883', '1886', '1888', '1889', '1893', '1899', '1900', '1901', '1902', '1904', '1908', '1909', '1910', '1912', '1915', '1918', '1919', '1920', '1922', '1925', '1929', '1931', '1935', '1937', '1940', '1942', '1943', '1947', '1948', '1949', '1950', '1951', '1952', '1953', '1955', '1962', '1963', '1965', '1970', '1971', '1973', '1975', '1976', '1978', '1980', '1984', '1988', '1990', '1994', '1995', '1996', '1997', '1999', '2006', '2010', '2011', '2014', '2015', '2016', '2017', '2018', '2019', '2020','2020', '2021']
                ...
                for year in years:
                    ...
                    QgsProject.instance().addMapLayer(layer, False)  # False, meaning not ready to add to legend
